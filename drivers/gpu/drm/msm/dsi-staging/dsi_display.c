...
/*	This doesn't work
	...
	dsi_panel_tx_cmd_set(display->panel, DSI_CMD_SET_OFF);
	dsi_panel_tx_shift_cmd_set_on(display->panel);
	mutex_unlock(&display->panel->panel_lock);*/

/*      This lasts too much time. Doesn't work, when screen is off
	dsi_panel_disable(display->panel);
